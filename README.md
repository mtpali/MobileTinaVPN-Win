...
> حالت TUN در نسخهٔ 0.3 فعال نیست. System Proxy فقط ترافیک برنامه‌هایی را پوشش می‌دهد که تنظیم Proxy ویندوز را رعایت می‌کنند. TUN/Wintun پس از تثبیت این پایه اضافه می‌شود.
